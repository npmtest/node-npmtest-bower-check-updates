...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-bower-check-updates/node_modules/bower-check-updates/lib/version-util.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-bower-check-updates/node_modules/bower-check-updates/lib/version-util.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-bower-check-updates/node_modules/bower-check-updates/lib/</a> &#187; version-util.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >        throw new Error(util.format('semverutils.parseRange returned null when trying to parse "%s". This is probably a problem with the "semver-utils" dependency. Please report an issue at https://github.com/se-panfilov/bower-check-updates/issues.', version))</span>
    }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if(n === 0) { <span class="cstat-no" title="statement not covered" >return precision; </span>}</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            return _.contains(VERSION_BASE_PARTS, precision) || semver[part];</span>
        })
